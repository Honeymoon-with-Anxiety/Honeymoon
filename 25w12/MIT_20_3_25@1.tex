...
Následně v Kate jsem pomocí datasheetu nakonfiguroval v \verb|Reset| osbluze převodník.

Z loňské práce jsem si zkopíroval sérii podprogramů na rozkládání čísla a zobrazování jej na displeji. Kód jsem následně doupravil dle požadavků úlohy.

Do \verb|Main| smyčky jsem napsal kód pro získání hodnoty z převodníku a následně jsem ho rozebral a jednotlivé číslice zobrazil na displeji.
