...
* změny poměru
	...
	* zaměstnavatel může zaměstnance převést na jinou práci
		...
		* dočasná ztráta předpokladů pro práci
	* zaměstnavatel nesmí zaměstnance převést na jinou práci
* skončení poměru
	* právní úkony dvou stranné → dohoda
	* právní úkony jednostranné
...
* pracovní doba
	...
	* nejdéle 40 hodin týdně
	* rozvržena rovnoměrně i nerovnoměrně
	* práce přesčas - na příkaz zaměstnavatele nebo s jeho souhlasem nad stanovenou pracovní dobu; výjimečně
	* noční práce
* dovolená na zotavenou
	* zaměstnanci v pracovním poměru za kalendářní rok
	* za část roku poměrnou část
	* zk. délka 4 týdny
	* dodatková dovolená
	* dobu čerpání dovolené určuje zaměstnavatel
	* oznámit 14 dní předem
	* zbývající část dovolené do konce příštího kalendářního roku
	* ze závažných provozních důvodů z dovolené odvolat
* odměňování práce
	* za vykonanou práci - mzda
		* složky
			...
			* odměny - za výkon
		* formy
			* časová - podle odpracovaných hodin
			* úkolová - podle splněných úkolů
			* podílová
			* smíšená
		* náhrada mzdy při překážkách
			* na straně zaměstnance - důležité osobní překážky; překážky z důvodu obecného zájmu
			* na straně zaměstnavatele - prostoje zaviněné zaměstnavatele; jiné závažné provozní překážky
	* rozpočtové a příspěvkové organizace a státní organizace - platy
	* složky mzdy (platu)
* 