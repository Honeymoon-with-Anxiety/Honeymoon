...
;save status register...
	in ADCReg, ADCH
	;here reconfigure channel...
;restrore status register
reti
...
;nuber of the channel to configure should be in r16
;you can call this AFTER you called load_n_channel subroutine
configure_channel:
	in r17, ADMUX

	;check what was the previous channel
	mov r18, r17
	andi r18, 0b00000111
	cpi r18, 0; predchozi kanal byl kanal0
	breq previous_channel_was_0
	cpi r18, 3
	breq previous_channel_was_3		
	cpi r18, 5
	breq previous_channel_was_5

	previous_channel_was_0:
		andi r17, 0b11111000
		ori r17, 0b00000011
		out ADMUX, r17 
		ret

	previous_channel_was_3:
...
;here are the channels I will be switching to.
next_channel:
.db 0, 3
.db 5, 0
