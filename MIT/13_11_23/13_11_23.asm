...
initZ_MojeAnimace:
	ldi ZL, low(2*mojeAnimace)
	ldi ZH, high(2*mojeAnimace)
ret
...
Main:
	rcall initZ_MojeAnimace
	clr r17 ; vycisti iterator loopu
	loopM:
		rcall nactiSnimek
		rcall zobrazeniSnimku
		ldi PDelReg, 255
		rcall Delay1m
...
;	.db 0b10001111, 0b11000111
;	.db 0b11100011, 0b11110001
...
mojeAnimace:
	.db 0b11111111, 0b01111111
	.db 0b00111111, 0b01011111
	.db 0b01101111, 0b01110111
	.db 0b01111011, 0b01111101
