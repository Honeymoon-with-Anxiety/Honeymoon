	...
	*/
    ...
    switch (uiChar)
    {
      ...
      case VK_RETURN:
		...
		//to be set here...
		TransmitLine=m_szLastCommand;
		TransmitLine+=END_TRANS;
		m_pOwner->m_pRS232Port->m_pOutputThread->SetBufferOut(TransmitLine);
		SetEvent(m_pOwner->m_pRS232Port->m_hWriteRequestEvent);
