...
COScopeCtrl::COScopeCtrl()
{
  ...
  m_crBackColor  = RGB(  40,   0,   0) ;  // see also SetBackgroundColor
  m_crGridColor  = RGB(  0, 255, 0) ;  // see also SetGridColor
  m_crPlotColor  = RGB(255, 255, 0) ;  // see also SetPlotColor
  ...
  // public member variables, can be set directly 
	CString m_strX  = "Samples";
	m_strXUnitsString.Format(m_strX) ;  // can also be set with SetXUnits
	CString m_strY	= "Size";
	m_strYUnitsString.Format(m_strY) ;  // can also be set with SetYUnits
...
void COScopeCtrl::SetLowerRange(double dLower)
{
  m_dLowerLimit     = dLower ;
  if(m_dLowerLimit>=m_dUpperLimit) m_dUpperLimit = m_dLowerLimit+10 ;
  m_dRange          = m_dUpperLimit - m_dLowerLimit ;
  m_dVerticalFactor = (double)m_nPlotHeight / m_dRange ; 
...
void COScopeCtrl::SetUpperRange(double dUpper)
{
  m_dUpperLimit     = dUpper ;
  if(m_dLowerLimit>=m_dUpperLimit) m_dLowerLimit = m_dUpperLimit-10 ;
  m_dRange          = m_dUpperLimit - m_dLowerLimit ;
  m_dVerticalFactor = (double)m_nPlotHeight / m_dRange ; 
...
void COScopeCtrl::InvalidateCtrl()
{
  ...
  CString m_font1 = "Arial";
  axisFont.CreateFont (14, 0, 0, 0, 300,
                       FALSE, FALSE, 0, ANSI_CHARSET,
                       OUT_DEFAULT_PRECIS, 
                       CLIP_DEFAULT_PRECIS,
                       DEFAULT_QUALITY, 
                       DEFAULT_PITCH|FF_SWISS, m_font1) ;
  ...
  m_dcGrid.SetTextAlign (TA_RIGHT|TA_TOP) ;
  frmt1 = "%d";
  strTemp.Format (frmt1, m_nPlotWidth/m_nShiftPixels) ; 
