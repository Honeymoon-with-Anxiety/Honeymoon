...
; Short description
; -----------------
; Program shows segmented digits on leds rotating and running from
...
Main:
			ldi		PDelReg, 250
			clr 	offset
			rcall 	LedOn		;turn the led on
Main10:	
			rcall	Delay1m
			rcall 	DispChar	;display the char
			rcall 	mod_inc		;increment display position
			rcall	mv_dig		;adjust the control lines
			inc 	offset		;is the number to display	
			cpi 	offset, 16	;we only have 16 digits in hex
